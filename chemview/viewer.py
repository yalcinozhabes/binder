...
from .utils import get_atom_color, get_atom_size
...
class MolecularViewer(RepresentationViewer):
    ...
    def ball(self,radius_type='vdw'):
        """Display atoms as balls with different radii
          radius_type='vdw'|'ionic'
        """
        colorlist = [get_atom_color(t) for t in self.topology['atom_types']]
        sizes = [get_atom_size(t,radius_type) for t in self.topology['atom_types']]
